...
class HandlerDataTool(ManagerHandlerBase):
    ...
    def handle(
        ...
        # MIC_AUDIO is not actually listened to for now, used only for heartbeat detection
        ...
        # For audio, do not send events before completion (flushed to disk) to avoid pushing intermediate fragments
