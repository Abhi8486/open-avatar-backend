...
class Tts2FaceEvent(Enum):
    START = 1001
    STOP = 1002
    INTERRUPT = 1003  # Interrupt current speech, clear audio queue
...
class LiteAvatarWorker:
    def __init__(self,
        ...
        self.max_audio_size = 24000 * 2 * 1  # sample_rate * bytes_per_sample * max_seconds (1 sec)
    ...
    def _event_input_loop(self):
        while True:
            ...
            if event == Tts2FaceEvent.START:
                ...
                # Interrupt current speech, clear audio queue
                if self.session_running and self.processor is not None:
                    ...
                    # Clear audio input queue of pending audio
