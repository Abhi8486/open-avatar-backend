...
class DifyContext(HandlerContext):
    def __init__(self, session_id: str):
        ...
        self.conversation_id = None  # Dify-specific conversation ID
...
class HandlerDify(HandlerBase, ABC):
    ...
    def _upload_image_to_dify(self, context: DifyContext, image_data):
        """
        Upload image to Dify and return file info
        """
        ...
        # Assuming image_data is PIL Image or numpy array, save to temp buffer first
        ...
        if response.status_code < 400:
            ...
            return result.get("id")  # Return file ID
        else:
                ...
                if img is not None:
                    ...
                    if file_id:
                        files.append({
                            ...
                            "upload_file_id": file_id  # Use uploaded file ID
                        })
